...
if (! function_exists('country')) {
     ...
     * @return \App\Suports\Intl\Country|string
     */
...
if (! function_exists('currency')) {
     ...
     *
     * @return \App\Suports\Intl\Currency|string
     */
    function currency()
    {
...
if (! function_exists('language')) {
     ...
     * @return \App\Suports\Intl\Language|string
     */
...
if (! function_exists('number')) {
     ...
     * @param array $options
     * @return \App\Suports\Intl\Number|string
     */
