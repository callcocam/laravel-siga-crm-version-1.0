    ...
    @mouseout  = "mouseout">
      ...
      <div @click="clickGroup" class="group-header w-full">
        <span class="flex items-center w-full">
          ...
          <!-- Group Tag -->
          <vs-chip class="ml-auto mr-4" :color="group.tagColor" v-if="group.tag && !verticalNavMenuItemsMin">{{ __(group.tag) }}</vs-chip>
        </span>
        ...
        <li v-for="(groupItem, index) in group.submenu" :key="index">
          ...
          <v-nav-menu-item
            ...
            :target = "groupItem.target">
              ...
              <vs-chip class="ml-auto" :color="groupItem.tagColor" v-if="groupItem.tag">{{ __(groupItem.tag) }}</vs-chip>
          </v-nav-menu-item>
